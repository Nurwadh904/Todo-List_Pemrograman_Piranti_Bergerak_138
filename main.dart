...
// Function addTask dengan validasi comprehensive dan feedback
  void addTask() {
    ...
    bool isDuplicate = tasks
        .any((task) => task.title.toLowerCase() == newTaskTitle.toLowerCase());
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            // ✅ Container cantik untuk area input form
            Container(
              padding: const EdgeInsets.all(16.0),
              decoration: BoxDecoration(
                color: Colors.grey[100],
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: task.isCompleted
                                    ? Border.all(
                                        ...
                                        width: 2) // Border hijau jika selesai
                                    : null,
                                boxShadow: [
                                  BoxShadow(
